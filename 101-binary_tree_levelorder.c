...
/**
 * recursion - function goes through the complete tree and each stores each node
...
/**
 * binary_tree_levelorder - theh function print the nodes element in a lever-order
 * @tree: root node
